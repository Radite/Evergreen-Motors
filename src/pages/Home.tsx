...
const modelDescriptions: Record<number, string> = {
  1: 'Electric Compact SUV',
  2: 'Electric Hatchback',
  3: 'Electric SUV',
  4: 'Hybrid SUV',
  5: 'Electric Sedan',
  6: 'Electric Compact SUV',
  7: 'Electric Hatchback',
};
  ...
  transform: translateY(-2px);
      ...
      <div className="hero-carousel">
        ...
        <div className="hero-carousel-controls">
          ...
          <a href="/offers" className="hero-carousel-button">
            Offers
          </a>
        </div>
              ...
              {extendedModels.map((model, index) => (
                <div key={`${model.id}-${index}`} className="model-card">
                  ...
                  <div className="model-card-buttons">
                    <button className="model-button">Learn More</button>
                    <button className="model-button">Test Drive</button>
                    <button className="model-button full-width">Range Calculator</button>
                  </div>
                </div>
              ))}
            </div>
